...
import styles from './ThreeCardsThreeWayChoiceSpreadForm.module.scss';
import {
  backImagePath,
...
const ThreeCardsThreeWayChoiceSpreadForm = props => {
...
export default ThreeCardsThreeWayChoiceSpreadForm;
