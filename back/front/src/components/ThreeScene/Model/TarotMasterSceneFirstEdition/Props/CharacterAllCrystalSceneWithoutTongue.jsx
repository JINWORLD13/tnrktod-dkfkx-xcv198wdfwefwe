...
import NumberHandlers from '../../../Utils/NumberHandlers';
...
export default memo(function CharacterAllCrystalScene({
  ...
  useEffect(() => {
    // 곰돌이 몸체 머티리얼 개선
    if (materials.FUegdMat) {
      materials.FUegdMat.roughness = 0.7;
      materials.FUegdMat.metalness = 0.0;
      materials.FUegdMat.envMapIntensity = 0.2;
      materials.FUegdMat.clearcoat = 0.1;
      materials.FUegdMat.clearcoatRoughness = 0.9;
    }

    if (materials.white) {
      materials.white.roughness = 0.6;
      materials.white.metalness = 0.0;
      materials.white.envMapIntensity = 0.2;
    }

    if (materials.black) {
      materials.black.roughness = 0.7;
      materials.black.metalness = 0.0;
      materials.black.envMapIntensity = 0.15;
    }

    if (materials.paw) {
      materials.paw.roughness = 0.6;
      materials.paw.metalness = 0.0;
      materials.paw.envMapIntensity = 0.2;
    }

    if (materials.clothes) {
      materials.clothes.roughness = 0.8;
      materials.clothes.metalness = 0.0;
      materials.clothes.envMapIntensity = 0.3;
      materials.clothes.normalScale?.set(1.2, 1.2);
    }
  }, [materials]);
  ...
  const { outNumber01, onNumber01, outNumber02, onNumber02 } = NumberHandlers({
    materials,
    answerForm,
  });
  ...
  const handlenNumber01Click = e => {
    // 초기 상태 확인
    if (answerForm?.isWaiting || answerForm?.isAnswered) {
      return;
    }
      ...
      <group name="Scene">
        ...
        >
          ...
          >
            <group name="RootNode001">
              ...
              <group name="Plane001" position={[0.018, 178.488, 0]}>
                <mesh
        ...
        >
          ...
          >
            <group name="RootNode003">
              ...
              <group name="Plane001002" position={[0.018, 178.488, 0]}>
                <mesh
        ...
        >
          ...
          >
            <group name="RootNode002">
              ...
              <group name="Plane002001" position={[0, 0, 0]} scale={0.01} />
            </group>
          </group>
        </group>
        <group
        ...
        <group
          ...
          onClick={e => {
            if (answerForm?.isWaiting || answerForm?.isAnswered) return;
            e.stopPropagation();
            if (answerForm?.isWaiting === false && visible)
              openTarotManualModal(e);
          }}
          visible={visible}
        >
          <mesh
