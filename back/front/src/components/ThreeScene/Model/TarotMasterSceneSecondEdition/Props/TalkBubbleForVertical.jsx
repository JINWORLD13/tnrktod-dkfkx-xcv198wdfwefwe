  ...
  return (
    <>
      <group name="TalkBubbleForVertical" ref={balloonRef} {...props}>
        ...
        <mesh name="TalkBubbleMaterial2" position={[-0.295, 1.55, -0.22]}>
          <circleGeometry args={[0.05, 120]} />
          <meshPhongMaterial color={'#1e1b4b'} />
        </mesh>
        <mesh name="TalkBubbleMaterial2_1" position={[-0.3, 1.55, -0.27]}>
          <circleGeometry args={[0.06, 120]} />
          <meshPhongMaterial color={'#6d28d9'} />
        </mesh>
        <mesh name="TalkBubbleMaterial3" position={[-0.27, 1.45, -0.22]}>
          <circleGeometry args={[0.03, 120]} />
          <meshPhongMaterial color={'#1e1b4b'} />
        </mesh>
        <mesh name="TalkBubbleMaterial3_1" position={[-0.275, 1.45, -0.27]}>
  ...
  ({ whichTarot, spreadListNumber, isLightOn, ...props }) => {
    ...
    return (
      <>
        ...
        <mesh name="TalkBubbleMaterial1" position={[-0.335, 1.65, -0.22]}>
          <primitive object={roundedRectShape} />
          <meshPhongMaterial color={'#1e1b4b'} flatShading />
        </mesh>
        <mesh name="TalkBubbleMaterial1_1" position={[-0.35, 1.63, -0.27]}>
          <primitive object={roundedRectShapeForOutter} />
          <meshPhongMaterial color={'#4c1d95'} flatShading />
        </mesh>
      </>
    );
  }
